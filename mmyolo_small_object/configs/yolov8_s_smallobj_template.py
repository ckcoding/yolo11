...
# Small-object oriented defaults.
img_scale = (1024, 1024)
max_epochs = 200
...
# Set to an official or private pretrained checkpoint if needed.
load_from = None

model = dict(
    backbone=dict(init_cfg=None),
    bbox_head=dict(head_module=dict(num_classes=num_classes)),
    # Lower score threshold and keep more candidates for tiny objects.
